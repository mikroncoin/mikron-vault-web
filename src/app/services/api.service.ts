...
export class ApiService {
  ...
  async accountHistory(account, count = 25, raw = false, include_comment = false): Promise<{history: any }> {
    return await this.request('account_history', { account, count, raw, include_comment });
  }
